...
! function(e, t) {
    ...
    return function(p, i, e, t) {
        var f = {
            ...
            detectFeatures: function() {
                ...
                for (var l, s, u = ["transform", "perspective", "animationName"], c = ["", "webkit", "Moz", "ms", "O"], d = 0; d < 4; d++) {
                    t = c[d];
                    for (var m = 0; m < 3; m++) l = u[m], s = t + (t ? l.charAt(0).toUpperCase() + l.slice(1) : l), !n[l] && s in e && (n[l] = s);
        ...
        function Z(e) {
            ...
            return le ? (Ue = 0, pt.forEach(function(e) {
        ...
        function F(e, t) {
            var n, i, o, a, r = We[e] + t[e],
                ...
                s = wt.x + t.x,
                u = wt.x - ft.x;
            if (n = r > Re.min[e] || r < Re.max[e] ? y.panEndFriction : 1, r = We[e] + t[e] * n, (y.allowPanToNext || K === h.currItem.initialZoomLevel) && (Pe ? "h" !== Fe || "x" !== e || Te || (l ? (r > Re.min[e] && (n = y.panEndFriction, Re.min[e], i = Re.min[e] - Ye[e]), (i <= 0 || u < 0) && 1 < Gt() ? (a = s, u < 0 && s > ft.x && (a = ft.x)) : Re.min.x !== Re.max.x && (o = r)) : (r < Re.max[e] && (n = y.panEndFriction, Re.max[e], i = Ye[e] - Re.max[e]), (i <= 0 || 0 < u) && 1 < Gt() ? (a = s, 0 < u && s < ft.x && (a = ft.x)) : Re.min.x !== Re.max.x && (o = r))) : a = s, "x" === e)) return a !== undefined && (d(a, !0), Ae = a !== ft.x), Re.min.x !== Re.max.x && (o !== undefined ? We.x = o : Ae || (We.x += t.x * n)), a !== undefined;
        ...
        function L(e) {
            if (!("mousedown" === e.type && 0 < e.button))
                ...
                var n = Z(e),
                    i = n.length;
                Ee = null, S(), Ce && 1 !== i || (Ce = Le = !0, f.bind(window, G, h), we = Ne = ze = be = Ae = Me = De = Te = !1, Fe = null, x("firstTouchStart", n), g(Ye, We), He.x = He.y = 0, g(dt, n[0]), g(mt, dt), ft.x = Ve.x * Ge, ht = [{
                    x: dt.x,
                    y: dt.y
                }], ve = xe = c(), w(K, !0), Ct(), Dt()), !Oe && 1 < i && !Ze && !Ae && (q = K, Oe = De = !(Te = !1), He.y = He.x = 0, g(Ye, We), g(st, n[0]), g(ut, n[1]), R(st, ut, It), bt.x = Math.abs(It.x) - We.x, bt.y = Math.abs(It.y) - We.y, ke = E(st, ut))
            }
        }
        ...
        function _(e) {
            ...
            if (x("pointerUp"), O(e, !1) && e.preventDefault(), le) {
                var n = f.arraySearch(pt, e.pointerId, "id"); - 1 < n && (t = pt.splice(n, 1)[0], navigator.msPointerEnabled ? (t.type = {
                    4: "mouse",
                    2: "touch",
                    3: "pen"
            ...
            1 === a && g(mt, o[0]), 0 !== a || Fe || Ze || (t || ("mouseup" === e.type ? t = {
                x: e.pageX,
                y: e.pageY,
                type: "mouse"
            ...
            var r = -1;
            if (0 === a && (Ce = !1, f.unbind(window, G, h), Ct(), Oe ? r = 0 : -1 !== gt && (r = c() - gt)), gt = 1 === a ? c() : -1, i = -1 !== r && r < 150 ? "zoom" : "swipe", Oe && a < 2 && (Oe = !1, 1 === a && (i = "zoomPointerUp"), x("zoomGestureEnded")), Ee = null, Me || Te || Ze || be)
                ...
                Ze || ("swipe" === i ? !Ae && K > h.currItem.fitRatio && Rt(ge) : Ft())
            }
        }
        var N, U, H, Y, W, B, G, X, V, K, q, $, j, J, Q, ee, te, ne, ie, oe, ae, re, le, se, ue, ce, de, me, pe, fe, he, ye, xe, ve, ge, we, be, Ie, Ce, De, Te, Me, Se, Ae, Ee, Oe, ke, Re, Pe, Ze, Fe, Le, ze, _e, Ne, Ue, He = {
                x: 0,
                y: 0
            },
            Ye = {
            ...
            Qe = {},
            et = function(e) {
                Pe && (e && (K > h.currItem.fitRatio ? Je || (jt(h.currItem, !1, !0), Je = !0) : Je && (jt(h.currItem), Je = !1)), o(Pe, We.x, We.y, K))
            },
            tt = function(e) {
            ...
            it = null,
            ot = function() {
                it && (f.unbind(document, "mousemove", ot), f.addClass(p, "pswp--has_mouse"), y.mouseUsed = !0, x("mouseUsed")), it = setTimeout(function() {
                    it = null
                }, 100)
            },
            at = {},
            ...
            lt = {
                ...
                init: function() {
                    if (!N && !U) {
                        var e;
                        h.framework = f, h.template = p, h.bg = f.getChildByClass(p, "pswp__bg"), de = p.className, N = !0, he = f.detectFeatures(), ue = he.raf, ce = he.caf, re = he.transform, pe = he.oldIE, h.scrollWrap = f.getChildByClass(p, "pswp__scroll-wrap"), h.container = f.getChildByClass(h.scrollWrap, "pswp__container"), W = h.container.style, h.itemHolders = ee = [{
                        ...
                        i && (h.ui = new i(h, f)).init(), x("firstUpdate"), Y = Y || y.index || 0, (isNaN(Y) || Y < 0 || Y >= Gt()) && (Y = 0), h.currItem = Bt(Y), (he.isOldIOSPhone || he.isOldAndroid) && (qe = !1), p.setAttribute("aria-hidden", "false"), y.modal && (qe ? p.style.position = "fixed" : (p.style.position = "absolute", p.style.top = f.getScrollY() + "px")), fe === undefined && (x("initialLayout"), fe = me = f.getScrollY());
                        var n = "pswp--open ";
                        for (y.mainClass && (n += y.mainClass + " "), y.showHideOpacity && (n += "pswp--animate_opacity "), n += se ? "pswp--touch" : "pswp--notouch", n += he.animationName ? " pswp--css_animation" : "", n += he.svg ? " pswp--svg" : "", f.addClass(p, n), h.updateSize(), B = -1, Ke = null, e = 0; e < 3; e++) nt((e + B) * Ve.x, ee[e].el.style);
                        pe || f.bind(h.scrollWrap, X, h), a("initialZoomInEnd", function() {
                            h.setContent(ee[0], Y - 1), h.setContent(ee[2], Y + 1), ee[0].el.style.display = ee[2].el.style.display = "block", y.focus && p.focus(), f.bind(document, "keydown", h), he.transform && f.bind(h.scrollWrap, "click", h), y.mouseUsed || f.bind(document, "mousemove", ot), f.bind(window, "resize scroll orientationchange", h), x("bindEvents")
                ...
                destroy: function() {
                    x("destroy"), Ut && clearTimeout(Ut), p.setAttribute("aria-hidden", "true"), p.className = de, J && clearInterval(J), f.unbind(h.scrollWrap, X, h), f.unbind(window, "scroll", h), Ct(), S(), Qe = null
                },
                ...
                goTo: function(e) {
                    var t = (e = s(e)) - Y;
                    Ke = t, Y = e, h.currItem = Bt(Y), Ge -= t, d(Ve.x * Ge), S(), Ze = !1, h.updateCurrItem()
                },
                next: function() {
                    h.goTo(Y + 1)
                },
                ...
                updateSize: function(e) {
                    if (!qe && y.modal) {
                        var t = f.getScrollY();
                        if (fe !== t && (p.style.top = t + "px", fe = t), !e && je.x === window.innerWidth && je.y === window.innerHeight) return;
                        je.x = window.innerWidth, je.y = window.innerHeight, p.style.height = je.y + "px"
                    }
                    if (Be.x = h.scrollWrap.clientWidth, Be.y = h.scrollWrap.clientHeight, D(), Ve.x = Be.x + Math.round(Be.x * y.spacing), Ve.y = Be.y, d(Ve.x * Ge), x("beforeResize"), B !== undefined) {
                ...
                zoomTo: function(t, e, n, i, o) {
                    ...
                    m(r), n ? A("customZoomTo", 0, 1, n, i || f.easing.sine.inOut, c) : c(1)
                }
            },
            st = {},
            ut = {},
                ...
                if (Ee) {
                    ...
                    if (0 !== e)
                        if (g(st, Ee[0]), ct.x = st.x - dt.x, ct.y = st.y - dt.y, Oe && 1 < e) {
                            ...
                            i < 0 && (i = 0), R(st, ut, vt), He.x += vt.x - It.x, He.y += vt.y - It.y, g(It, vt), We.x = u("x", n), We.y = u("y", n), we = K < n, K = n, et()
                        } else {
                            if (!Fe) return;
                            if (Le && (Le = !1, 10 <= Math.abs(ct.x) && (ct.x -= Ee[0].x - mt.x), 10 <= Math.abs(ct.y) && (ct.y -= Ee[0].y - mt.y)), dt.x = st.x, dt.y = st.y, 0 === ct.x && 0 === ct.y) return;
                            ...
                            }(c(), st.x, st.y), Me = !0, Re = h.currItem.bounds, F("x", ct) || (F("y", ct), m(We), et())
                        }
                }
            },
            kt = function() {
                var t, n, i = {
                    ...
                    calculateSwipeSpeed: function(e) {
                        n = 1 < ht.length ? (t = c() - ve + 50, ht[ht.length - 2][e]) : (t = c() - xe, mt[e]), i.lastFlickOffset[e] = dt[e] - n, i.lastFlickDist[e] = Math.abs(i.lastFlickOffset[e]), 20 < i.lastFlickDist[e] ? i.lastFlickSpeed[e] = i.lastFlickOffset[e] / t : i.lastFlickSpeed[e] = 0, Math.abs(i.lastFlickSpeed[e]) < .1 && (i.lastFlickSpeed[e] = 0), i.slowDownRatio[e] = .95, i.slowDownRatioReverse[e] = 1 - i.slowDownRatio[e], i.speedDecelerationRatio[e] = 1
                    },
                    calculateOverBoundsAnimOffset: function(t, e) {
                        i.backAnimStarted[t] || (We[t] > Re.min[t] ? i.backAnimDestination[t] = Re.min[t] : We[t] < Re.max[t] && (i.backAnimDestination[t] = Re.max[t]), i.backAnimDestination[t] !== undefined && (i.slowDownRatio[t] = .7, i.slowDownRatioReverse[t] = 1 - i.slowDownRatio[t], i.speedDecelerationRatioAbs[t] < .05 && (i.lastFlickSpeed[t] = 0, i.backAnimStarted[t] = !0, A("bounceZoomPan" + t, We[t], i.backAnimDestination[t], e || 300, f.easing.sine.out, function(e) {
                            We[t] = e, et()
                        }))))
                    },
            ...
            Pt = function(e, t) {
                ...
                var l, s = Ve.x * Ge,
                    u = Math.abs(s - wt.x);
                return l = n || s > wt.x == 0 < t.lastFlickSpeed.x ? (l = 0 < Math.abs(t.lastFlickSpeed.x) ? u / Math.abs(t.lastFlickSpeed.x) : 333, l = Math.min(l, 400), Math.max(l, 250)) : 333, xt === Y && (n = !1), Ze = !0, x("mainScrollAnimStart"), A("mainScroll", wt.x, s, l, f.easing.cubic.out, d, function() {
                    S(), Ze = !1, xt = -1, !n && xt === Y || h.updateCurrItem(), x("mainScrollAnimComplete")
        ...
        n("Gestures", {
            publicMethods: {
                initGestures: function() {
                    ...
                    }(le = he.pointerEvent) && he.touch && (he.touch = !1), le ? navigator.msPointerEnabled ? e("MSPointer", "Down", "Move", "Up", "Cancel") : e("pointer", "down", "move", "up", "cancel") : he.touch ? (e("touch", "start", "move", "end", "cancel"), se = !0) : e("mouse", "down", "move", "up"), G = ie + " " + oe + " " + ae, X = ne, le && !se && (se = 1 < navigator.maxTouchPoints || 1 < navigator.msMaxTouchPoints), h.likelyTouchDevice = se, V[ne] = L, V[ie] = z, V[oe] = _, ae && (V[ae] = V[oe]), he.touch && (X += " mousedown", G += " mousemove mouseup", V.mousedown = V[ne], V.mousemove = V[ie], V.mouseup = V[oe]), se || (y.allowPanToNext = !1)
                }
            }
        });
        ...
        var Ut, Ht, Yt, Wt, Bt, Gt, Xt = function(r, e, l, t) {
                ...
                function u() {
                    T("initialZoom"), l ? (h.template.removeAttribute("style"), h.bg.removeAttribute("style")) : (v(1), e && (e.style.display = "block"), f.addClass(p, "pswp--animated-in"), x("initialZoom" + (l ? "OutEnd" : "InEnd"))), t && t(), Wt = !1
                }
                ...
                var c, d, m = l ? y.hideAnimationDuration : y.showAnimationDuration;
                if (!m || !s || s.x === undefined) return x("initialZoom" + (l ? "Out" : "In")), K = r.initialZoomLevel, g(We, r.initialPosition), et(), p.style.opacity = l ? 0 : 1, v(1), void(m ? setTimeout(function() {
                    u()
                }, m) : u());
                c = H, d = !h.currItem.src || h.currItem.loadError || y.showHideOpacity, r.miniImg && (r.miniImg.style.webkitBackfaceVisibility = "hidden"), l || (K = s.w / r.w, We.x = s.x, We.y = s.y - me, h[d ? "template" : "bg"].style.opacity = .001, et()), M("initialZoom"), l && !c && f.removeClass(p, "pswp--animated-in"), d && (l ? f[(c ? "remove" : "add") + "Class"](p, "pswp--animate_opacity") : setTimeout(function() {
                    ...
                    if (x("initialZoom" + (l ? "Out" : "In")), l) {
                        var t = s.w / r.w,
                            ...
                            a = _e,
                            e = function(e) {
                                1 === e ? (K = t, We.x = s.x, We.y = s.y - fe) : (K = (t - o) * e + o, We.x = (s.x - n) * e + n, We.y = (s.y - fe - i) * e + i), et(), d ? p.style.opacity = 1 - e : v(a - e * a)
                            };
                        c ? A("initialZoom", 0, 1, m, f.easing.cubic.out, e, u) : (e(1), Ut = setTimeout(u, m + 20))
                    } else K = r.initialZoomLevel, g(We, r.initialPosition), et(), v(1), d ? p.style.opacity = 1 : v(1), Ut = setTimeout(u, m + 20)
                }, l ? 25 : 90)
            },
            Vt = {},
            Kt = [],
            ...
            publicMethods: {
                ...
                setContent: function(t, n) {
                    ...
                    if (o) {
                            ...
                            if (o.loadComplete = function(e) {
                                    if (N) {
                                        if (t && t.index === n) {
                                            ...
                                            e.imageAppended ? !Wt && e.placeholder && (e.placeholder.style.display = "none", e.placeholder = null) : he.transform && (Ze || Wt) ? Kt.push({
                                                item: e,
                                                baseDiv: a,
                                                img: e.img,
                                                index: n,
                        ...
                        Yt || n !== Y ? tt(o) : (Pe = a.style, Xt(o, i || o.img)), t.el.innerHTML = "", t.el.appendChild(a)
                    } else t.el.innerHTML = ""
                },
        ...
        n("Tap", {
            ...
            publicMethods: {
                ...
                setupDesktopZoom: function(e) {
                    ...
                    function n() {
                        h.mouseZoomedIn && (f.removeClass(p, "pswp--zoomed-in"), h.mouseZoomedIn = !1), K < 1 ? f.addClass(p, "pswp--zoom-allowed") : f.removeClass(p, "pswp--zoom-allowed"), o()
                    }
                ...
                toggleDesktopZoom: function(e) {
                    ...
                    var t = y.getDoubleTapZoom(!0, h.currItem),
                        n = K === t;
                    h.mouseZoomedIn = !n, h.zoomTo(n ? h.currItem.initialZoomLevel : t, e, 333), f[(n ? "remove" : "add") + "Class"](p, "pswp--zoomed-in")
                }
            }
        });
        ...
        var rn, ln, sn, un, cn, dn, mn, pn, fn, hn, yn, xn, vn = {
                history: !0,
                galleryUID: 1
            },
            gn = function() {
                if (sn && clearTimeout(sn), rt || Ce) sn = setTimeout(gn, 500);
                    ...
                    xn ? "#" + n !== window.location.hash && history[pn ? "replaceState" : "pushState"]("", document.title, i) : pn ? yn.replace(i) : yn.hash = n, pn = !0, ln = setTimeout(function() {
                        un = !1
                    }, 60)
                }
            };
            ...
            publicMethods: {
                initHistory: function() {
                    if (f.extend(y, vn, !0), y.history) {
                        yn = window.location, pn = fn = hn = !1, mn = nn(), xn = "pushState" in history, -1 < mn.indexOf("gid=") && (mn = (mn = mn.split("&gid=")[0]).split("?gid=")[0]), a("afterChange", h.updateURL), a("unbindEvents", function() {
                            f.unbind(window, "hashchange", h.onHashChange)
                        });
                        var e = function() {
                            dn = !0, fn || (hn ? history.back() : mn ? yn.hash = mn : xn ? history.pushState("", document.title, yn.pathname + yn.search) : yn.hash = ""), on()
                        };
                        a("unbindEvents", function() {
                            H && e()
                        }), a("destroy", function() {
                        ...
                        var t = mn.indexOf("pid="); - 1 < t && "&" === (mn = mn.substring(0, t)).slice(-1) && (mn = mn.slice(0, -1)), setTimeout(function() {
